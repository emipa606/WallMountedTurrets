...
{ 
    ...
    public void TurretTopTick()
        ...
        {
            Vector3 b = new Vector3(parentTurret.def.building.turretTopOffset.x, 0f, parentTurret.def.building.turretTopOffset.y);
            float turretTopDrawSize = parentTurret.def.building.turretTopDrawSize;
            Matrix4x4 matrix = default(Matrix4x4);
            matrix.SetTRS(parentTurret.DrawPos + Altitudes.AltIncVect + b, CurRotation.ToQuat(), new Vector3(turretTopDrawSize, 1f, turretTopDrawSize));
